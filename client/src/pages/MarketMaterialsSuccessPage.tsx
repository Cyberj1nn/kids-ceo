...
export default function MarketMaterialsSuccessPage() {
  return (
    <div className="evp">
      <div className="evp-status">
        <div className="evp-status__card">
          ...
          <p className="evp-status__text">
            Спасибо! Письмо со&nbsp;ссылкой на&nbsp;закрытый Telegram-канал с&nbsp;маркетинговыми материалами отправлено на&nbsp;почту,
            которую вы&nbsp;указали при оплате. Если не&nbsp;видите его в&nbsp;течение 5&nbsp;минут&nbsp;—
            проверьте папку «Спам».
          </p>
          <div className="evp-status__actions">
            <Link to="/market_materials" className="evp-btn evp-btn--blue evp-btn--lg">
