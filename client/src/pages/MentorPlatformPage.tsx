...
const PROCESS = [
  ...
  { num: '03', time: '5–10 дней', title: 'Доработки и индивидуальные модули', text: 'Если нужны кастомные блоки помимо базы — добавляем их на этом этапе. Стоимость доработок — от 5 000 ₽ за модуль, согласуется заранее.' },
      ...
      <main id="top">
        ...
        <section className="mp-hero">
          <div className="mp__wrap mp-hero__grid">
            ...
            <div className="mp-hero__visual mp-reveal">
              <div className="mp-hero__device">
                <div className="mp-hero__device-bar">
                  <span /><span /><span />
                </div>
                <img
                  className="mp-hero__device-img"
        ...
        <section className="mp-section" id="faq">
          <div className="mp__wrap">
            ...
            <div className="mp-faq__list">
              {FAQ.map((item, i) => (
                <details
                  className="mp-faq__item mp-reveal"
                  key={i}
                  open={openFaq === i}
                >
                  <summary
